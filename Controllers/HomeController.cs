...
namespace EventEase.Controllers
{
    ...
    {
        private static readonly List<EventItem> EventsList = new List<EventItem>
        {
            new EventItem { Id = 1, Title = "Global Tech Summit 2026", Category = "Tech", Date = "Oct 15, 2026", Time = "09:00 AM", Location = "Silicon Convention Center", Price = 149.99m, ImageUrl = "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=600&auto=format&fit=crop", Description = "Join key industry leaders, innovators, and developers for keynote talks and tech workshops.", SeatsAvailable = 120, Organizer = "TechGlobal Inc.", IsFeatured = true },
            new EventItem { Id = 2, Title = "Symphony Under The Stars", Category = "Music", Date = "Oct 20, 2026", Time = "07:30 PM", Location = "Grand Amphitheater Park", Price = 79.50m, ImageUrl = "https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=600&auto=format&fit=crop", Description = "A magical outdoor evening performance by the National Philharmonic Orchestra.", SeatsAvailable = 85, Organizer = "Aura Music Productions", IsFeatured = true },
            new EventItem { Id = 3, Title = "International Food & Wine Expo", Category = "Workshop", Date = "Nov 02, 2026", Time = "11:00 AM", Location = "Metropolitan Exhibition Hall", Price = 49.00m, ImageUrl = "https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=600&auto=format&fit=crop", Description = "Taste world-class cuisines, wine pairing sessions, and live masterclasses from celebrity chefs.", SeatsAvailable = 200, Organizer = "Culinary Arts Guild", IsFeatured = true },
            new EventItem { Id = 4, Title = "Marathon Championship 2026", Category = "Sports", Date = "Nov 12, 2026", Time = "06:00 AM", Location = "City Coastal Drive", Price = 29.99m, ImageUrl = "https://images.unsplash.com/photo-1461896836934-ffe607ba8211?w=600&auto=format&fit=crop", Description = "Annual city runner marathon. Includes runner kit, medal, and hydration stations.", SeatsAvailable = 450, Organizer = "City Athletic Club", IsFeatured = false },
            new EventItem { Id = 5, Title = "Modern Art & Design Gala", Category = "Art", Date = "Nov 18, 2026", Time = "05:00 PM", Location = "Contemporary Art Museum", Price = 89.00m, ImageUrl = "https://images.unsplash.com/photo-1561214115-f2f134cc4912?w=600&auto=format&fit=crop", Description = "Exclusive showcase of contemporary paintings, digital installations, and sculpture galleries.", SeatsAvailable = 60, Organizer = "Modern Art Alliance", IsFeatured = false },
            new EventItem { Id = 6, Title = "AI & Future Robotics Workshop", Category = "Tech", Date = "Dec 05, 2026", Time = "10:00 AM", Location = "Innovation Hub Lab 4", Price = 199.00m, ImageUrl = "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?w=600&auto=format&fit=crop", Description = "Hands-on practical session building autonomous robotics and neural networks.", SeatsAvailable = 40, Organizer = "RoboCorp Labs", IsFeatured = true }
        };
